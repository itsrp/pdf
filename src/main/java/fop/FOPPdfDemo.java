...
public class FOPPdfDemo {
    ...
    public void convertToPDF()  throws IOException, FOPException, TransformerException {
        // the XSL FO file
        File xsltFile = new File("C:\\rp\\projects\\src\\main\\resources\\pdf-template.xsl");
        File xmlFile = new File("C:\\rp\\projects\\src\\main\\resources\\employee.xml");
        InputStream xsltFileInputStream = FOPPdfDemo.class.getClass().getResourceAsStream("pdf-template.xsl");
        InputStream xmlFileInputStream = FOPPdfDemo.class.getClass().getResourceAsStream("employee.xml");
